...
class ServiceManagementService {
  ...
  Future<AddServiceResponse> addService({
    ...
    required String employeePhotoBase64, // Parameter sekarang adalah Base64 string
    required String servicePhotoBase64, // Parameter sekarang adalah Base64 string
  }) async {
    ...
    debugPrint('ServiceManagementService: Panjang Base64 Foto Karyawan: ${employeePhotoBase64.length}');
    debugPrint('ServiceManagementService: Panjang Base64 Foto Layanan: ${servicePhotoBase64.length}');
    ...
    try {
      ...
      debugPrint('ServiceManagementService: Token ditemukan. Membuat permintaan POST dengan JSON body.');
      ...
      final Map<String, dynamic> requestBody = {
        ...
        'employee_photo': employeePhotoBase64, // Mengirim string Base64
        'service_photo': servicePhotoBase64, // Mengirim string Base64
      };

      debugPrint('ServiceManagementService: Body Permintaan JSON: ${json.encode(requestBody)}');
      ...
      final response = await http.post(
        ...
        body: json.encode(requestBody), // Encode Map menjadi string JSON
      ).timeout(const Duration(seconds: 30)); // Tambahkan timeout untuk mencegah permintaan menggantung
